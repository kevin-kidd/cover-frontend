...
const emptyLoans: Listing[] = [
	emptyLoanListing,
	emptyLoanListing,
	emptyLoanListing,
	emptyLoanListing,
];
const emptyBorrows: Listing[] = [
	emptyBorrowListing,
	emptyBorrowListing,
	emptyBorrowListing,
	emptyBorrowListing,
...
export const useHomeStore = create<HomeState>()((set) => ({
	...
	toggleListing: (by: string) =>
		set((state) => ({ toggles: { ...state.toggles, listingType: by } })),
	toggleToken: (by: string) =>
		set((state) => ({ toggles: { ...state.toggles, tokenType: by } })),
