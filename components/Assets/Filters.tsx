...
const SearchTokenBox: FunctionComponent<{ tokenType: string }> = ({ tokenType }) => {
    return (
...
const RefreshBalances: FunctionComponent = () => {
    ...
    return (
        <div className="flex ml-3 h-7 my-auto pl-1">
            <RefreshIcon onClick={handleReset} className={`h-full 
        ...
        <div className="flex items-center w-full sm:w-1/2 justify-end">
            <label htmlFor="default-toggle" className="inline-flex relative items-center cursor-pointer">
                <input type="checkbox" id="default-toggle" className="sr-only peer"
                       checked={toggles.hideZeroBalances} onChange={handleToggle}
                />
