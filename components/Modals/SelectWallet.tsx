	...
	return (
		<>
			...
			<ul className="mt-4 mb-2 space-y-3">
				...
				<li>
					<p className="hover:cursor-not-allowed transition duration-300 flex items-center p-3 text-base font-bold rounded-lg group dark:bg-gray-700 dark:text-white">
						<Image
							src={metamaskIcon}
							height="25"
							width="25"
