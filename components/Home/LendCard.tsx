...
export const LendCard: FunctionComponent<{ listing: Listing }> = ({ listing }) => {
    ...
    <div className={`col-span-1 flex w-full h-full justify-center ${loading ? null : "hover:cursor-pointer"}`}>
      <div className="flex flex-col bg-[#1A2128] w-full object-cover px-4 4k:px-10 rounded-lg big:rounded-2xl 4k:rounded-3xl items-center shadow-sm hover:shadow-2xl transition duration-300">
        <div className="border-b border-[#8B98FF] w-full py-2 4k:pt-5 4k:pb-4 flex justify-center">
          <p className="card-title big:font-medium text-kindasmall desktop:text-base big:text-xl 4k:text-4xl">Offering to Lend</p>
        </div>
        <>
          {
            loading ?
                ...
                <>
                  { listing.isPartiallyFunded ?
                      <>
                        <div className="border-b border-[#8B98FF] flex flex-col w-full py-1 4k:py-4">
                          <div className="w-full inline-flex justify-center items-end">
                            ...
                            <p className={`card-upto 4k:pl-3 desktop:pl-2 sm:pl-1 pl-0.5 ${classes.gradient}`}>{listing.lending.name}</p>
                          </div>
                      ...
                      <>
                        <div
                            className="border-b border-[#8B98FF] flex flex-col w-full py-2 desktop:py-3 big:py-4 4k:py-5">
                  ...
                  <div className="w-full pt-2 pb-1 4k:py-4 inline-flex justify-center items-end">
                    ...
                    <p className="pl-2 4k:pl-4 text-[#FF6969] text-kindasmaller desktop:text-kindasmall big:text-xl 4k:text-4xl">+{listing.returnPercentage}%
                      return</p>
                  </div>
          ...
          { listing.collateral.images.length === 0 ?
              null :
