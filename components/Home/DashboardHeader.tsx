      ...
      <div className="top-0 z-10 flex-shrink-0 flex h-auto border-b border-black mx-2">
        ...
        <div className="flex-1 flex px-4">
          <div className="flex-1 flex my-4 lg:mr-10 md:mr-2 sm:mr-6 justify-end">
            <TokenTypeToggle />
            <ListingTypeToggle />
            <button className="hidden sm:flex rounded-full border border-[#b2bfcd] h-12 w-12 p-1 text-[#b2bfcd] hover:text-[#e0e5eb] hover:border-[#e0e5eb] transition duration-150">
