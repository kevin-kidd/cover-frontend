...
const Item: FunctionComponent<{ item: MenuItem; active: boolean }> = ({
	item,
	active,
}) => {
	...
	const disabled: boolean = !isConnected && item.walletRequired;
			...
			>
				<div
					className={classNames(
						...
						active
							? "border-[#7BBD75]"
							: "border-[#eeeeee]/90 transition duration-150",
					)}
				>
					<svg
						...
						className={classNames(
							...
							active
								? "fill-[#7BBD75]/90"
								: "group-hover:fill-[#eeeeee]/90 fill-[#c0c0c0] transition duration-150",
						)}
					>
				...
				<p
					className={classNames(
						...
						active
							? "text-[#eeeeee]"
							: "text-[#c0c0c0] group-hover:text-[#eeeeee]/90",
					)}
				>
					{item.title}
				</p>
