...
import { useOnClickOutside } from "../../func/helper";
...
const Menu: FunctionComponent<{ activeTitle: string }> = ({ activeTitle }) => {
	...
	return (
		<>
			{/* Mobile */}
			<div
				className="absolute h-screen z-40 lg:hidden w-0"
				role="dialog"
				aria-modal="true"
			>
				<Transition
				...
				>
					...
					<div className="fixed inset-0 flex z-40">
						<div
							className="flex flex-col overflow-x-hidden overflow-y-auto max-w-sidebar pb-6 w-full bg-[#1A2128]"
							ref={mobileMenuRef}
						>
							<div
								onKeyDown={(e) => e.key === "Enter" && toggleMenu()}
								onClick={() => toggleMenu()}
								className="flex row-span-1 justify-end pr-5 pt-5"
							>
								<button
									type="button"
