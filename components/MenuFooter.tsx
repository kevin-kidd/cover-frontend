...
export const MenuFooter: FunctionComponent = () => {
        ...
        return (
          <div className="flex bg-gray-700 p-4 overflow-x-hidden border-r-2 border-b-2 border-gray-800">
            <div className="flex items-center">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="h-full w-full py-3 fill-gray-500 hover:fill-gray-400 transition duration-150">
    ...
    return (
        <div className="flex items-center justify-center mb-[8vw] lg:mb-14 md:mb-14 sm:mb-14">
            <button 
